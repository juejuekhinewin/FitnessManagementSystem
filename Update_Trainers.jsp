  ...
  <p></p>
	...
	<%   
	      ...
	      Class.forName("com.mysql.cj.jdbc.Driver");
	   	  String sql ="select* from trainers where trainer_name='"+name+"'";
	  ...
	  %>
	   ...
	   <form action="Trainers_Update_Servlet" method="post">	  
	      ...
	      <table width="600" border="1">  
			...
			<tr>
				<th width="181">
				<div align="left">Schedule </div></th>
				<td><input type="text" name="schedule" size="20" value="<%=rs.getString(5)%>"></td>
			</tr>
			</table> 
