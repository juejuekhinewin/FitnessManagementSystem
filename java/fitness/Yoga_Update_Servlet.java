...
/**
 * Servlet implementation class Yoga_Update_Servlet
 */
@WebServlet("/Yoga_Update_Servlet")
public class Yoga_Update_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	String Name,Age,Email,Phone,Pay,Weight;   
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Yoga_Update_Servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try
        {
           ...
           String sql="update yoga_membership set name='"+Name+"'"+
					", age='"+Age+"'"+
					", email='"+Email+"'"+
					", phone_number='"+Phone+"'"+
					", payments='"+Pay+"'"+
