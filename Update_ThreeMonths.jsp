  ...
  <p></p>
	...
	<%   
	      ...
	      Class.forName("com.mysql.jdbc.Driver");
	   	  String sql ="select* from threemonthpackage where name='"+name+"'";
	  ...
	  %>
	   ...
	   <form action="ThreeMonths_Update_Servlet" method="post">	  
	      ...
	      <table width="600" border="1">  
			...
			<tr>
				...
				<td><input type="text" name="phoneno" size="20" value="<%=rs.getString(3)%>"></td>
			</tr>
			<tr>
				<th width="181">
			...
			<tr>
				...
				<td><input type="text" name="weight" size="20" value="<%=rs.getString(5)%>"></td>
			</tr>
			
			
			<tr>
				<th width="181">
				<div align="left">Height </div></th>
				<td><input type="text" name="height" size="20" value="<%=rs.getString(6)%>"></td>
			</tr>
			
			<tr>
				<th width="181">
				<div align="left">Payments </div></th>
				<td><input type="text" name="payment" size="10" value="<%=rs.getString(7)%>"></td>
			</tr>
			</table> 
