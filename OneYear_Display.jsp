...
<div class="main">
  ...
  <p></p>
	...
	<% 
	   ...
	   ResultSet rs = st.executeQuery("select* from oneyearpackage");

	   
	   %>
	   
	   
	<div class="d1"><p style="color:brown;font-size:50px;text-align:center">Packages</p>
	<center>
	...
	<table border="1" width ="60%">
		...
		<tr>
			...
			<td><img src="<%=rs.getString(7) %>" width="115" height="128"></td>	
			
			<td><a href="Delete_OneYear.jsp?delete=<%=rs.getString(1)%>"><button class="button button1">delete</button></a></td>
		</tr>
		<% } %>
	</table>
	</form>
