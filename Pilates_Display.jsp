...
<div class="main">
  ...
  <p></p>
	...
	<% 
	   ...
	   ResultSet rs = st.executeQuery("select* from pilates_membership");
	...
	<table border="2" width ="100%">
		...
		<tr>
			...
			<td><a href="Delete_Pilates.jsp?delete=<%=rs.getString(1)%>"><button class="button button1">delete</button></a></td>
		</tr>
		<% } %>
	</table>
	</form>
