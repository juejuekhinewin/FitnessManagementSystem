...
<div class="main">
  ...
  <p></p>
	...
	Connection con= DriverManager.getConnection("jdbc:mysql://localhost:3307/fitnessdb","root","");
	   ...
	   ResultSet rs = st.executeQuery("select* from yoga_membership");
	...
	<table border="1" width ="60%">
		...
		<tr>
			...
			<td><a href="Update_Yoga.jsp?delete=<%=rs.getString(1)%>"><button class="button">save</button></a></td>
			<td><a href="Delete_Yoga.jsp?delete=<%=rs.getString(1)%>"><button class="button button1">delete</button></a></td>
		</tr>
		<% } %>
	</table></center>
