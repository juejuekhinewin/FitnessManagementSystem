...
<div class="main">
  ...
  <p></p>
	...
	Connection con= DriverManager.getConnection("jdbc:mysql://localhost:3307/fitnessdb","root","");
	   ...
	   ResultSet rs = st.executeQuery("select* from lowerbody_membership");
	...
	<table border="1" width ="60%">
		...
		<tr>
			...
			<td><a href="Delete_Lower.jsp?delete=<%=rs.getString(1)%>"><button class="button button1">delete</button></a></td>
		</tr>
		<% } %>
	</table></center>
