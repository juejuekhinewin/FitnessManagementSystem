  ...
  <p></p>
	...
	<%   
	      ...
	      Class.forName("com.mysql.cj.jdbc.Driver");
	   	  String sql ="select* from sixmonthpackage where name='"+name+"'";
	  ...
	  %>
	   ...
	   <form action="SixMonths_Update_Servlet" method="post">	  
	      ...
	      <table width="600" border="1">  
			...
			<tr>
				...
				<td><input type="text" name="payment" size="7" value="<%=rs.getString(7)%>"></td>
			</tr>
			</table> 
