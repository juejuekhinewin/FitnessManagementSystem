...
<div class="main">
  ...
  <p></p>
	...
	<div class="d1"><p style="color:brown;font-size:50px;text-align:center">Trainer lists</p>
	<center>
	...
	<table border="2" width ="100%">
		...
		<tr>
			...
			<td><a href="Delete_Trainers.jsp?delete=<%=rs.getString(1)%>"><button class="button button1">delete</button></a></td>
		</tr>
		<% } %>
	</table>
	</form>
